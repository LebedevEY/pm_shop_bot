...
exports.USER_STATES = exports.CALLBACK_DATA = exports.COMMANDS = exports.MESSAGES = void 0;
/**
...
exports.MESSAGES = {
    ...
    ORDER_CREATED: (orderNumber) => `Спасибо! Ваш заказ №${orderNumber} принят. Мы свяжемся с вами для подтверждения.`,
    ...
    PRODUCT_ADDED: (quantity) => `Товар добавлен в корзину: ${quantity} шт.`,
    PRODUCT_REMOVED: 'Товар удален из корзины.',
    CART_CLEARED: 'Корзина очищена.',
    ERROR_GENERIC: 'Произошла ошибка. Попробуйте позже.',
    ERROR_ORDER: (error) => `Произошла ошибка при оформлении заказа: ${error}`,
    ERROR_CART: (error) => `Ошибка при работе с корзиной: ${error}`,
