...
class OrderService {
    ...
    async create(orderData) {
        const products = await Promise.all(orderData.items.map((item) => this.productRepository.findOne({ where: { id: item.productId } })));
    ...
    async createOrderFromTelegram(orderData) {
